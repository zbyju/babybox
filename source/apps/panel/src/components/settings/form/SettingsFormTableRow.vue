  ...
  <tr>
    ...
    <td>
      <div class="newvalue-wrapper">
        <BaseInput type="text" :value="props.value" :state="inputState" @input="inputChange" />
...
import { displayTemperature, displayVoltage, prettyFloat } from "@/utils/panel/data-display";
...
function dataToString(data: string | null | undefined, type: SettingsTableRowValueType): string {
  if (data === null) return "—";
