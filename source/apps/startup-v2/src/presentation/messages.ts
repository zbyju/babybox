...
export const Messages = {
  ...
  update: {
    ...
    networkError:
      "Nelze se pripojit k repozitari. Zkontrolujte pripojeni k internetu.",
  ...
  build: {
    ...
    success: (durationMs: number) =>
      `Build uspesne dokoncen za ${Math.round(durationMs / 1000)}s.`,
    failed: "Build selhal.",
  ...
  override: {
    ...
    rollbackFailed:
      "Rollback selhal! Aplikace muze byt v nekonzistentnim stavu.",
  },
  ...
  install: {
    ...
    prerequisiteMissing: (name: string) =>
      `Chybi pozadovana zavislost: ${name}`,
