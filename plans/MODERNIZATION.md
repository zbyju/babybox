...
| 1 | [Cleanup & Dead Code](./modernization/01-cleanup.md) | Not Started | None | Quick wins, reduces noise |
| 2 | [TypeScript Completion](./modernization/02-typescript-completion.md) | Not Started | None | Better tooling, catches bugs |
